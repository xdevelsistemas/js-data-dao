...
export class Application {
    ...
    routes: (app: express.Application, store: JSData.DS, passport: Passport , appConfig: Config.AppConfig) => express.Application

    constructor(cfg: Config.AppConfig, routes: (app: express.Application, store: JSData.DS, passport: Passport , appConfig: Config.AppConfig) => express.Application ) {
        this.app = express()
        this.appConfig = cfg
        /**
    ...
    handlePassport(app: express.Application, store: JSData.DS, passport: Passport): express.Application {
    ...
    handleRoutes(app: express.Application, store: JSData.DS, passport: Passport): express.Application {
        /**
